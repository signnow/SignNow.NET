    ...
    public partial class DocumentExamples
    {
        ...
        public async Task GetRoutingDetailAsync()
        {
            ...
            try
            {
                ...
                // Attributes can be null if not configured, so this assertion was removed.
                // Assert.IsNotNull(routingDetail.Attributes);
            }
            catch (SignNowException ex)
            {
                ...
                System.Console.WriteLine($"Document does not have routing details configured: {ex.Message}");
