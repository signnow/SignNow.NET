        ...
        public async Task CreateBulkInviteFromTemplateAsync()
        {
            ...
            var result = await testContext.Documents
                .CreateBulkInviteFromTemplateAsync(
                    ...
                    "Thank you for choosing our services. Please review and sign your contract.")
                .ConfigureAwait(false);
        ...
        public async Task CreateBulkInviteFromTemplateWithMultipleRolesAsync()
        {
            ...
            var result = await testContext.Documents
                .CreateBulkInviteFromTemplateAsync(
                    ...
                    fileName,
                    documentsFolder.Id,
                    "Single-Role Document Signing",
                    "This document requires your signature. Please review and sign.")
                .ConfigureAwait(false);
