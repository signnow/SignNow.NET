...
namespace SignNow.Net.Interfaces
{
    ...
    public interface IEventSubscriptionService
    {
        ...
        /// <returns></returns>
        Task CreateEventSubscriptionAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Propagates notification that operations should be canceled.</param>
        /// <returns></returns>
        Task GetEventSubscriptionAsync(CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Propagates notification that operations should be canceled.</param>
        /// <returns></returns>
        Task UpdateEventSubscriptionAsync(CancellationToken cancellationToken = default);
